...
var init=function(){burger.addEventListener('click',openMenu,!1);window.addEventListener('scroll',scrollFx,!1);window.addEventListener('load',scrollFx,!1);$('a[href^="#"]').on('click',scrolly)};doc.on('ready',init)
